...
/*
  IMPORTANTE:
  Bloqueamos los gestos del navegador directamente
  sobre la zona de los tres toques.
*/

function bloquearZoomZona(e) {
  ...
  function(e) {
    ...
    if (toquesSecretos >= 3) {
      ...
      /*
        ...
        sin permitir que el navegador
        interprete el tercer toque
        como gesto de zoom.
      */
...
/* =====================================================
   EVITAR CLICK POSTERIOR DE LA ZONA SECRETA
===================================================== */
