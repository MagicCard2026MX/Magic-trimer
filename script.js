...
/*
   La configuración comienza escondida.
*/
...
/*
   Dos toques rápidos en la esquina
   superior izquierda.
*/
...
function voltearCarta(elemento) {
  ...
  /*
    La PRIMERA carta que se voltee
    se convierte en la carta forzada.
  */
...
mazo.addEventListener(
  ...
  function(e) {
    ...
    /*
      No sacar cartas mientras
      la caja está visible.
    */
...
startBtn.addEventListener(
  ...
  function() {
    ...
    /*
      Ocultar nuevamente la configuración
      después de iniciar.
    */
